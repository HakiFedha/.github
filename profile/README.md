...
#### BitMentor (People-Powered Guidance)
...
### 🧠 Assisted Support Layer

#### Faragha Assitant (Privacy Assistant)
...
3. **Human + Tool Collaboration:** Technology supports, but does not replace, human knowledge.  
4. **Inclusive Design:** Built for low-bandwidth and real-world constraints.  
5. **Accessible Education:** If it requires a computer science degree, we’ve failed.  
